...
export const HeroComputerIde: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-full sm:max-w-4xl mx-auto my-4 sm:my-8 relative group overflow-hidden px-1 sm:px-0">
      ...
      <div className="relative rounded-2xl bg-surface-50/95 border border-white/15 shadow-2xl backdrop-blur-2xl overflow-hidden flex flex-col w-full max-w-full">
